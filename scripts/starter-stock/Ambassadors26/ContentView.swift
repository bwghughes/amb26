...
struct ContentView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("Mac Initiative Builder")
    }
    ...
    private var inputPane: some View {
        VStack(alignment: .leading, spacing: 16) {
            PaneHeader(
                ...
                subtitle: "Paste or record rough notes from a channel sales conversation."
            )
        ...
        TextEditor(text: $transcript)
            ...
            .overlay(alignment: .topLeading) {
                if transcript.isEmpty {
                    Text("e.g. Customer has 320 Windows laptops, most four years old…")
                        .font(.body)
